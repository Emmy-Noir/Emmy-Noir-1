...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="relative flex min-h-[78vh] items-center overflow-hidden bg-noir text-ivory">
        ...
        <div className="container relative z-10 flex flex-col items-start gap-8 py-24">
          <span className="eyebrow text-ivory/60">EMMY NOIR · Modern Fashion House</span>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            >
              Explore the house <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              href="/collections"
      ...
      <section className="container py-20 md:py-28">
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <ProductImage tone="ink" alt="Editorial placeholder" />
            <ProductImage tone="champagne" alt="Editorial placeholder" className="mt-10" />
          </div>
        </div>
      </section>
        ...
        <section className="border-y border-border bg-secondary/40 py-20 md:py-28">
          <div className="container">
            ...
            <div className="mt-12 grid gap-x-6 gap-y-10 md:grid-cols-3">
              {featuredCollections.slice(0, 3).map((c) => (
                <CollectionCard
                  key={c.id}
                  title={c.name}
      ...
      <section className="container py-20 md:py-28">
        <div className="mx-auto max-w-editorial text-center">
          ...
          <p className="mt-6 font-serif text-2xl leading-relaxed md:text-3xl">
            "We design for the person who values restraint — who understands
            that true luxury is quiet, considered, and built to last."
          </p>
